...
from utils.file_persistence import load_projection_results
...
def _load_outbound(dims: pd.DataFrame | None = None,
    ...
    """Carga demanda proyectada outbound desde los resultados de Proyección de Stock
    (guardados en session_state vía save_projection_results).
